...
#### Begin STAGE 0: ARG
#################################################################################"
$projectName = "InternalARM"   # This name is used to generate names for Azure resources, such as storage account name.
$location = "eastus"
...
$mainFileName                       = "az.arm-template.deploy.all.json"
$managedIdentityFileName            = "az.01A.deploy.managed-identity.json" 
$keyVaultFileName                   = "az.01D.deploy.key-vault.json" 
$keyVaultAccessPolicyFileName       = "az.02A.deploy.key-vault.access-policies.json" 
$keyVaultAccessPolicyEntryFileName  = "az.02A.deploy.key-vault.access-policy.entry.json"
$keyVaultKeyFileName                = "az.03A.deploy.key-vault.key.json" 
$keyVaultSecretFileName             = "az.03A.deploy.key-vault.secret.json" 
$containerRegistryFileName          = "az.04D.deploy.container-registry.json" 
$files = @()

$files += $mainFileName
$files += $managedIdentityFileName
$files += $keyVaultFileName
$files += $keyVaultAccessPolicyFileName
$files += $keyVaultAccessPolicyEntryFileName
$files += $keyVaultKeyFileName
$files += $keyVaultSecretFileName
$files += $containerRegistryFileName
